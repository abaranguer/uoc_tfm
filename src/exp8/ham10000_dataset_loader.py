...
from src.exp8.ham10000_dx_decoder import dx_to_description
from src.exp8.ham10000_dx_decoder import dx_to_int
...
if __name__ == '__main__':
    # lesion_id,image_id,dx,dx_type,age,sex,localization,dataset
    metadata_path = src.exp8.ham10000_autoconfig.get_metadata_path()
    df = pandas.read_csv(metadata_path)
    train_set, test_set = train_test_split(df, test_size=0.25)

    image_folder = src.exp8.ham10000_autoconfig.get_images_path()
