...
import src.exp5.ham10000_transforms_sets as transforms_sets
from src.exp5.ham10000_albumentation_dataset_loader import Ham10000AlbumentationDataset
from src.exp5.ham10000_analyzer import Ham10000DatasetAnalyzer
...
class Ham10000DatasetWeightedSplitter:
    ...
    def __init__(self, dataset_metadata_path, dataset_images_path, set_number,
        ...
        self.albumentation_transforms = transforms_sets.get_set(set_number)
